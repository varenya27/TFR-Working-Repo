...
figure = corner.corner(
    ...
    # quantiles=[0.16,0.84], 
    range=[(1,4), (2.5,7), (-0.05,0.13)],
    show_titles=True, 
    label_kwargs={"fontsize": 12},
    title_kwargs={"fontsize": 10},
    color = 'b',alpha=0.1,fill_contours = 1,
    contour_kwargs={"color": 'r'}
);

# corner.corner(flat_samples, labels=labels ,levels=(0.68,0.95,0.99),color = 'b',alpha=0.1,fill_contours = 1,show_titles=True,title_fmt='.3f',max_n_ticks = 3, title_kwargs={"fontsize": 14},label_kwargs={"fontsize": 16},contour_kwargs={"color": 'r'})
...
plt.errorbar(x, y,err_y,err_x, alpha=0.5, fmt='h', ms=5, mfc='cornflowerblue',color='cornflowerblue', mew=1, ecolor='darkgrey', capsize=2.0, zorder=0, label='Individual Data');
...
plt.savefig(f'besfit{L}_KROSS.png')
plt.show()
